  ...
  return (
    ...
    >
      ...
      <View className="flex-1 min-w-0">
        ...
        <Text className="text-white/40 text-xs truncate">{employee.title}</Text>
        {employee.department && (
          <Text className="text-white/30 text-[10px] truncate">
            {employee.department}
          </Text>
        )}
        {employee.city && (
    ...
    >
      <View className="flex items-center justify-between mb-4">
        <View className="flex items-center gap-2">
          ...
          <Text className="text-white font-bold text-sm">Employés</Text>

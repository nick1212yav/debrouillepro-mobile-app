  ...
  return (
    ...
    >
      <View className="flex items-start justify-between gap-2">
        <View className="flex-1 min-w-0">
          <View className="flex items-center gap-2">
            ...
            {service.rating !== undefined && (
              <Text className="flex items-center gap-0.5 text-amber-400 text-xs">
        ...
        <View className="flex flex-col items-end text-right flex-shrink-0 text-xs text-white/30">
  ...
  return (
    ...
    >
      <View className="flex items-center justify-between mb-4">
        <View className="flex items-center gap-2">
          <View className="w-8 h-8 rounded-xl flex items-center justify-center bg-orange-500/10 text-orange-400">
            <Wrench size={15} />
          </View>
          <Text className="text-white font-bold text-sm">Services</Text>

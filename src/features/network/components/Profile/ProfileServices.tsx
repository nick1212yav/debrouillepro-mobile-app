    ...
    >
      <View className="flex items-center justify-between mb-4">
        <View className="flex items-center gap-2">
          ...
          <Text className="text-white font-bold text-sm">Services proposés</Text>
          <Text className="text-white/30 text-xs"><Text>(</Text>{services.length}<Text>)</Text></Text>
        </View>
        {editable && (
          <Pressable
            onPress={onAdd}

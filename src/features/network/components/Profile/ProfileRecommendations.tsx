    ...
    >
      <View className="flex items-center justify-between">
        <View className="flex items-center gap-2">
          <View className="w-8 h-8 rounded-full flex items-center justify-center bg-indigo-500/20 text-indigo-400 text-xs font-bold">
          ...
          <View>
            ...
            <Text className="text-white/30 text-xs">{date}</Text>
          </View>
        </View>
  ...
  return (
    ...
    >
      <View className="flex items-center justify-between mb-4">
        <View className="flex items-center gap-2">
          <View className="w-8 h-8 rounded-xl flex items-center justify-center bg-yellow-500/10 text-yellow-400">
            <MessageSquare size={15} />
          </View>
          <Text className="text-white font-bold text-sm">Recommandations</Text>
          <Text className="text-white/30 text-xs">
            <Text>(</Text>{recommendations.length}<Text>)</Text></Text>
        </View>
        {editable && onAdd && (
          <Pressable
            onPress={onAdd}
          ...
          >
            <ThumbsUp size={12} />
            <Text>Recommander</Text></Pressable>
        )}
      </View>

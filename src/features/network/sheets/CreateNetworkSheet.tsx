...
export function CreateNetworkSheet({
    ...
    undefined.getCurrentPosition(
      async (pos) => {
        try {
          ...
          UIService.openToast("Impossible de récupérer l'adresse", "error");
        }
        setLocating(false);
      },
      () => {
    ...
    for (const imageUrl of imageUrls) {
      ...
      if (imageUrl.startsWith("data:image") || imageUrl.startsWith("blob:")) {
        try {
          ...
          UIService.openToast("Échec de l'upload d'une image. Veuillez réessayer.", "error");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      UIService.openToast("Publication réseau créée avec succès !", "success");
      onSuccess?.();
      onClose();
    } catch (err) {
  ...
  return (
    ...
    >
      <Pressable
        ...
        style={{ borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", borderStyle: "solid", maxHeight: "calc(100dvh - 24px)", height: "min(900px, calc(100dvh - 24px))" }}
          ...
          <View className="space-y-4">
            ...
            <View>
              ...
              <TextInput
                ...
                placeholder="Ex: Développeur Full Stack disponible"
                className="w-full rounded-2xl px-4 py-3 text-sm text-white placeholder:text-white/25 outline-none bg-white/5 border border-white/10"
              />
            </View>
            ...
            <View>
              ...
              <TextInput
                ...
                placeholder="Décrivez votre profil, vos compétences, votre offre..."

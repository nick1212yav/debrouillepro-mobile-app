  ...
  return (
    <View className="space-y-3">
      <View className="flex items-center gap-2">
        ...
        <Text className="text-sm font-medium text-white/50">Marketplace</Text>
      </View>
      <View className="gap-2">
        {items.slice(0, 4).map((item) => (
          <Pressable
            ...
            className="relative rounded-xl overflow-hidden group bg-white/5 border border-white/5"
          >
            {item.image ? (
              <Image
            ...
            {item.location && (
              <View className="absolute top-2 right-2 flex items-center gap-0.5 bg-black/50 px-1.5 py-0.5 rounded-lg">
            ...
            {item.rating && (
              <View className="absolute top-2 left-2 flex items-center gap-0.5 bg-black/50 px-1.5 py-0.5 rounded-lg">
            ...
            {onLike && (
              <Pressable
                ...
                className="absolute bottom-2 right-2 p-1.5 rounded-lg bg-black/50"
              >
                <Heart
                  size={12}
                  className={

...
export function CommunityEvents({
  ...
  if (events.length === 0) {
    return (
      <View className="p-4 text-center bg-white/5 rounded-2xl border border-white/5">
        <Calendar size={32} className="text-white/20 mx-auto mb-2" />
        <Text className="text-white/30 text-sm">Aucun événement</Text>
      </View>
    );
  }
  ...
  return (
    <View className="space-y-3">
      <View className="flex items-center gap-2">
        ...
        <Text className="text-sm font-medium text-white/50">Événements</Text>
      </View>
          ...
          >
            <View className="flex gap-3 p-3">
              ...
              {event.coverImage ? (
                ...
                <View className="flex-shrink-0 w-20 h-20 rounded-xl flex items-center justify-center bg-purple-500/20">
              ...
              <View className="flex-1 min-w-0">
                ...
                <View className="mt-1 space-y-0.5">
                  <View className="flex items-center gap-1 text-xs text-white/30">
                    <Clock size={10} />
                  ...
                  <View className="flex items-center gap-3 text-xs text-white/30">
                    <Text className="flex items-center gap-1">
                      <Users size={10} />
                      {event.attendeeCount}<Text>/</Text>{event.maxAttendees || "∞"}
                    </Text>
                    <Text>

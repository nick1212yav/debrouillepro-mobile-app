  ...
  return (
    <View className="space-y-3">
      <View className="flex items-center gap-2">
        ...
        <Text className="text-sm font-medium text-white/50">Immobilier</Text>
      </View>
          ...
          >
            {property.image ? (
              <Image
               ...
               source={{ uri: property.image }} accessibilityLabel={property.title}/>
            ) : (
              <View className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-teal-500/20">
            ...
            <View className="flex-1 min-w-0">
              ...
              <View className="flex items-center gap-2 text-white/30 text-[10px] mt-0.5">
                ...
                <View className="flex items-center gap-0.5">
                  <Square size={10} />
                  <Text>{property.surface}<Text>m²</Text></Text>
                </View>
              </View>
            </View>

          ...
          <>
                ...
                >
                  {item.image ? (
                    <Image
                     ...
                     source={{ uri: item.image }} accessibilityLabel={item.name}/>
                  ) : (
                  ...
                  <View className="flex-1 min-w-0">
                    <Text className="text-white text-sm truncate">{item.name}</Text>
            ...
            <View className="pt-3 mt-3 border-t border-white/10">
              ...
              <Pressable
                ...
                style={{  }}
              >
                <ShoppingCart size={16} /> <Text>Commander</Text></Pressable>
            </View>
          </>
        )}
      </Pressable>

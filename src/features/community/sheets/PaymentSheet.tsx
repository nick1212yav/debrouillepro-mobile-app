          ...
          >
            {step === "choose" && (
              <>
                <View className="p-4 rounded-2xl bg-white/5 border border-white/10">
                  <Text className="text-white/60 text-sm">Montant à payer</Text>
                ...
                <Pressable
                  ...
                  style={{  }}
                >
                  <Text className="text-white">Payer maintenant</Text>
                </Pressable>
              </>
            )}
            ...
            {step === "processing" && (
              <View className="flex flex-col items-center justify-center py-10">
                <View className="w-16 h-16 rounded-full border-4 border-purple-400 border-t-transparent animate-spin" />
                <Text className="text-white/60 mt-4">Traitement du paiement...</Text>
              </View>
            )}

            {step === "done" && (
              <View className="flex flex-col items-center justify-center py-10">
                <View className="w-16 h-16 rounded-full bg-green-500/20 flex items-center justify-center">
                  <Check size={32} className="text-green-400" />
                </View>
                <Text className="text-white font-bold text-lg mt-4">
                  <Text>Paiement réussi !</Text></Text>
                <Text className="text-white/40 text-sm">
                  <Text>Merci pour votre confiance</Text></Text>
              </View>
            )}
          </View>
        </View>

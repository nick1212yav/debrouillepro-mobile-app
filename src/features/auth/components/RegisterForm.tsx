...
export function RegisterForm({ onLoginClick }: RegisterFormProps) {
  ...
  return (
    <View className="space-y-5">
      <View>
        <Text className="block mb-1.5 text-xs font-medium text-white/50">
          Nom complet *
        </Text>
        ...
        <TextInput
          ...
          className="w-full rounded-2xl px-4 py-3 text-sm text-white placeholder:text-white/25 outline-none"
          style={{ backgroundColor: "rgba(255,255,255,.06)", borderWidth: 1, borderColor: "rgba(255,255,255,.10)", borderStyle: "solid" }}
         editable={!(loading)}/>
      ...
      <View>
        ...
        <View className="relative">
          <TextInput
            ...
            className="w-full rounded-2xl px-4 py-3 pr-10 text-sm text-white placeholder:text-white/25 outline-none"
            style={{ backgroundColor: "rgba(255,255,255,.06)", borderWidth: 1, borderColor: "rgba(255,255,255,.10)", borderStyle: "solid" }}
           editable={!(loading)}/>
      ...
      <View className="flex items-start gap-2 text-xs text-white/40">
        <input className="mt-1"  accessibilityRole="checkbox" accessibilityState={{ checked: false }}/>

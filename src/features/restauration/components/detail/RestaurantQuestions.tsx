...
export function RestaurantQuestions() {
  ...
  return (
    <View className="px-4 py-4 border-t border-white/[0.04]"><View className="flex items-center gap-2 mb-3"><HelpCircle size={16} className="text-white/40" /><Text className="text-xs font-bold uppercase tracking-wider text-white/40">F.A.Q & Questions
        </Text></View><View className="space-y-3 text-left">{qas.map((qa, i) => (

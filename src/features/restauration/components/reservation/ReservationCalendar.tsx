      ...
      <View className="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
        {days.map((day) => {
          ...
          return (
            ...
            >
              <Text
                className={`text-[9px] uppercase font-black tracking-wider ${isSelected ? "text-emerald-400" : "text-white/30"}`}
              >
                {day.dayName}
              </Text>
              <Text
                className={`text-base font-black ${isSelected ? "text-emerald-400" : "text-white/80"}`}
              >
                {day.dayNumber}
              </Text>

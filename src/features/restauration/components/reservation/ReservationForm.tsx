...
export function ReservationForm({
  ...
  return (
    ...
    >
      ...
      <ReservationCalendar selectedDate={date} onChange={setDate} />

      {/* 2. Heure d'arrivée */}
      <View>
        <Text className="block text-[10px] text-white/40 uppercase font-bold mb-1.5 flex items-center gap-1">
          <Clock size={12} /> Heure d'arrivée
        </Text>
      ...
      <View>
        <Text className="block text-[10px] text-white/40 uppercase font-bold mb-1.5 flex items-center gap-1">
          <Users size={12} /> Nombre de couverts
        </Text>
        <View className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-4 py-2">
          <Text className="flex-1 text-xs font-semibold text-white/80">
          ...
          <View className="flex items-center gap-2">
            <Pressable
              ...
              className="w-7 h-7 rounded-lg bg-white/10 flex items-center justify-center font-bold text-white"
            >
              <Text>-</Text></Pressable>
            <Pressable
      ...
      <View>
        <Text className="block text-[10px] text-white/40 uppercase font-bold mb-1.5 flex items-center gap-1">
          <Compass size={12} /> Emplacement de la table
        </Text>
      ...
      <View>
        ...
        <TextInput
          ...
          placeholder="Ex: table en terrasse abritée, allergies, célébration d'anniversaire..."

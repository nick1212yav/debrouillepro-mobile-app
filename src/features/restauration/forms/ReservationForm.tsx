    ...
    <View className="space-y-4 text-left">
      ...
      <View className="space-y-1.5">
        ...
        <Picker
         ...
         selectedValue={section} enabled={!(isSubmitting)}>
          <Picker.Item label="Salle Standard" value="standard" />
          <Picker.Item label="Terrasse en plein air" value="terrace" />
          <Picker.Item label="Espace Salon VIP" value="vip" />
          <Picker.Item label="Salon Privé d'affaires" value="private_room" />
        </Picker>
        {errors.section && (
          <Text className="text-[10px] text-rose-500 flex items-center gap-1 font-semibold">
            <AlertCircle size={10} />
      ...
      <View className="space-y-1.5">
        <Text className="block text-[10px] text-white/40 uppercase font-black tracking-wider">
          Demandes particulières (Allergies, événement...)
        </Text>
        <TextInput
         
          placeholder="Ex: table près de la scène d'orchestre, intolérance à l'arachide..."
          value={request}

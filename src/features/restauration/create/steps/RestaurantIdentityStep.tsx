    ...
    <View className="space-y-6">
      <View>
        ...
        <Text className="text-white/40 text-sm">
          Donnez une première impression forte à vos futurs clients.
        </Text>
      </View>
      ...
      <View className="space-y-4">
        ...
        <View>
          ...
          <Textarea
            ...
            placeholder="Décrivez votre restaurant, ses spécialités, l'ambiance..."
      ...
      <Button
        onPress={onNext}
        disabled={!isValid}
        className="w-full h-12 rounded-xl bg-orange-600 text-white font-bold text-base"
      >

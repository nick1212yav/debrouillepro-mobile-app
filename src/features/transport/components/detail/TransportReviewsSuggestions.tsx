      ...
      <View className="p-5 rounded-3xl border border-white/5 bg-white/[0.01] space-y-4">
        <View className="flex items-center justify-between pb-3 border-b border-white/5">
          ...
          <View className="flex items-center gap-1.5">
            ...
            <Text className="text-xs font-bold text-white">4.97/5</Text>
          </View>
        </View>

        {/* Témoignages */}
        <View className="space-y-3">
          <View className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/5">
            <View className="flex justify-between items-center">
              <Text className="text-xs font-bold text-white">Patrick K.</Text>
              <Text className="text-[9px] text-white/40">Il y a 3 jours</Text>
            </View>
            <Text className="text-xs text-white/60 mt-1 leading-relaxed">
              "Chauffeur très calme et prudent. Véhicule climatisé du début à la
            ...
            >
              <View className="flex items-center gap-2">
                ...
                <View>
                  ...
                  <Text className="text-[9px] text-white/40">{alt.time}</Text>
                </View>
              </View>
              <View className="text-right">
                <Text className="text-xs font-bold text-violet-400">
                  {alt.price} <Text>FC</Text></Text>
                <Text className="text-[8px] text-emerald-400"><Text>Direct</Text></Text>
              </View>
            </View>
          ))}
        </View>

      ...
      <View className="space-y-3.5">
        ...
        <View className="flex items-start gap-3">
          ...
          <View>
            <Text className="text-xs font-bold text-white">
              Chauffeur habilité DébrouillePro [2]
            </Text>
            <Text className="text-[10px] text-white/40 leading-relaxed mt-0.5">
              Identité vérifiée, permis de conduire validé et casier judiciaire
        ...
        {isInsured && (
          <View className="flex items-start gap-3">
            ...
            <View>
              <Text className="text-xs font-bold text-white">
                Responsabilité Civile active [2]
              </Text>
              <Text className="text-[10px] text-white/40 leading-relaxed mt-0.5">
                Le véhicule (immatriculé{" "}
                <Text className="font-mono text-white/60">
                  {vehiclePlate || "N/A"}
                </Text>
                ) dispose d'une assurance voyage active couvrant l'ensemble des
                passagers [2].
              </Text>
            </View>
          </View>
        ...
        <View className="flex items-start gap-3">
          ...
          <View>
            <Text className="text-xs font-bold text-white">
              <Text>Équipement d'assistance de secours</Text></Text>
            <Text className="text-[10px] text-white/40 leading-relaxed mt-0.5">
              <Text>Présence obligatoire à bord d'une trousse de premiers soins, d'un extincteur et de triangles de sécurité.</Text></Text>
          </View>
        </View>
      </View>
    </View>

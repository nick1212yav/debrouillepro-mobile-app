            ...
            <View className="flex items-center gap-3">
              ...
              <View>
                <Text className="text-xs font-bold text-white">
                  {task.vehicleModel} ({task.plate})
                </Text>
                <Text className="text-[10px] text-white/40 mt-0.5">
                  {task.taskType} • Échéance : {task.dueDate}
                </Text>
              </View>
            </View>

            <View className="flex items-center gap-1.5 text-[10px] font-bold">
              {task.status === "completed" ? (
                <Text className="text-emerald-400 flex items-center gap-1">
                  <CheckCircle2 size={11} /> <Text>Fait [2]</Text></Text>
              ) : (
                <Text
                  className={

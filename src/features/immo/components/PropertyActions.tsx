  ...
  return (
    <View className="space-y-3">
      <View className="flex flex-wrap gap-2">
        <Pressable
          onPress={onView}
          className="flex-1 py-2.5 rounded-xl text-xs font-medium flex items-center justify-center gap-1.5 text-white"
          style={{  }}
        >
          <Eye size={14} /> <Text>Voir le bien</Text></Pressable>
        <Pressable
          onPress={onContact}
        ...
        >
          <Phone size={14} /> <Text>Contacter</Text></Pressable>
        <Pressable
          onPress={onVisit}
          className="flex-1 py-2.5 rounded-xl text-xs font-medium flex items-center justify-center gap-1.5"
          style={{ backgroundColor: `${color}20`, borderStyle: "solid" }}
        >
          <Calendar size={14} /> <Text>Visiter</Text></Pressable>
      </View>

      <View className="flex items-center gap-2 pt-3 border-t border-white/5">
        <Pressable
          onPress={onLike}

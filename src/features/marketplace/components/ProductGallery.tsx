        ...
        {hasError ? (
          ...
          <View className="relative w-full h-full">
            ...
            <Image
              ...
              loading="lazy" source={{ uri: currentImage }} accessibilityLabel={`${title} - ${currentIndex + 1}`}
            />
          </View>
        )}
            ...
            <View className="relative w-full max-w-4xl max-h-[80vh]">
              {hasError ? (
                ...
                <Image
                  ...
                  onError={() => handleImageError(currentIndex)} source={{ uri: currentImage }} accessibilityLabel={title}
                />
              )}

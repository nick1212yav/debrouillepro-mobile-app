    ...
    <View className="space-y-3">
      <View className="flex items-center justify-between">
        ...
        <Pressable
          ...
          style={{  }}
        >
          <Plus size={12} /> <Text>Créer</Text></Pressable>
      </View>
          ...
          >
            <View className="flex items-center justify-between mb-2">
              <View className="flex items-center gap-2">
                <code className="text-white font-mono text-sm bg-white/10 px-2 py-0.5 rounded">
                  {coupon.code}
                </code>
                <Pressable
              ...
              <View className="flex items-center gap-1">
                <Pressable className="text-white/30">
                  <Edit size={14} />
                </Pressable>
                <Pressable
            ...
            <View className="flex items-center gap-4 text-sm">
              ...
              <Text className="text-white/30 text-xs ml-auto">
                {coupon.used}<Text>/</Text>{coupon.maxUses} <Text>utilisés</Text></Text>
            </View>

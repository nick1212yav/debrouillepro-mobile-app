            ...
            >
              {conv.buyerAvatar ? (
                <Image
                 ...
                 source={{ uri: conv.buyerAvatar }} accessibilityLabel={conv.buyerName}/>
              ) : (
              ...
              <View className="flex-1 min-w-0">
                <View className="flex items-center justify-between">
                  ...
                  <Text className="text-white/30 text-[10px] flex items-center gap-0.5">
                    <Clock size={10} /> {formatDate(conv.lastMessageAt)}
                  </Text>
                </View>

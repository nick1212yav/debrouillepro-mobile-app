    ...
    <View className="fixed inset-0 z-50 flex items-end justify-center bg-black/50">
      ...
      >
        <View className="flex items-center justify-between mb-6">
          <Text className="text-white font-bold text-lg">Adresse de livraison</Text>
          <Pressable
            onPress={onClose}
        ...
        {step === "address" ? (
          ...
          <View className="space-y-4">
            ...
            <View className="flex items-center justify-between py-3 border-t border-white/10">
            ...
            <View
              ...
              style={{ backgroundColor: "rgba(255,255,255,0.05)" }}
            >
              <Text className="text-white/40 text-xs mb-1"><Text>Livraison à</Text></Text>

            ...
            <View className="flex flex-wrap gap-2">
              {categories.map((cat) => (
                <Pressable
                  ...
                  style={{ backgroundColor: category === cat.id
                                          ? "rgba(249,115,22,0.2)"
          ...
          <View className="gap-3">
            <View>
              ...
              <TextInput
                ...
                placeholder="0"
                className="w-full px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm outline-none placeholder:text-white/25"
               keyboardType="numeric"/>
            </View>
            <View>
              <Text className="text-white/60 text-xs font-semibold mb-2">
                <Text>Prix max</Text></Text>
              <TextInput

      ...
      >
        ...
        {coupons.length === 0 ? (
          <View className="text-center py-10">
            <Ticket size={36} className="mx-auto mb-3 text-white/15" />
            <Text className="text-white/30 text-sm">Aucun coupon disponible</Text>
          </View>
        ) : (
          <View className="space-y-3">
            {coupons.map((coupon) => (
              ...
              >
                  ...
                  <View>
                    ...
                    {coupon.minPurchase && (
                      <Text className="text-white/30 text-xs">
                        Achat minimum: {coupon.minPurchase} {coupon.currency}
                      </Text>
                    )}
                    {coupon.expiresAt && (
                ...
                <code className="text-[10px] bg-white/5 px-2 py-0.5 rounded text-purple-300 font-mono block mt-2">
                  {coupon.code}
                </code>
              </View>
            ))}

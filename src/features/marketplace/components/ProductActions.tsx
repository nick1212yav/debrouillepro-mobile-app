  ...
  return (
    <View className="flex flex-wrap items-center gap-2">
      ...
      <Pressable
        onPress={onShare}
        disabled={disabled}
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-white/60 disabled:opacity-40"
      ...
      <Pressable
        onPress={onReport}
        disabled={disabled}
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-white/30 disabled:opacity-40"
        style={{ backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", borderStyle: "solid" }}
      >
        <Flag size={16} />
      </Pressable>

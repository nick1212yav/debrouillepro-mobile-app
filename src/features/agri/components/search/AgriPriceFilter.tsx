      ...
      <View className="space-y-1.5">
        ...
        <View className="gap-3">
          <View className="relative flex items-center">
            <Text className="absolute left-3 text-[10px] text-white/20 font-bold">
              {curr}
            </Text>
            <TextInput
              ...
              placeholder="Minimum"
              className="w-full h-11 bg-white/[0.03] border border-white/5 rounded-xl pl-11 pr-3 text-white text-xs outline-none"

...
export function AgriPrice({
  ...
  return (
    <Text className={`text-green-400 font-extrabold text-sm ${className}`}>{formatPrice(price, currency)}<Text className="text-white/40 font-normal text-[10px]">{" "}/ {priceUnit}</Text></Text>
  );
}

  ...
  return (
    <View className="p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
      <View className="flex items-start gap-3">
        ...
        <View>
          <Text className="text-sm font-medium text-white/80"><Text>Garantie incluse</Text></Text>
          {months && (
            <Text className="text-xs text-white/50">{months} <Text>mois de garantie</Text></Text>
          )}
          {description && (
          ...
          {isTransferable && (
            <View className="flex items-center gap-1 mt-1">
              ...
              <Text className="text-xs text-emerald-400/60">
                <Text>Garantie transférable</Text></Text>
            </View>
          )}
        </View>
      </View>

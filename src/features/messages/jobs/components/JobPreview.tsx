    ...
    >
      ...
      >
        {job.companyLogo ? (
          ...
          <View
            ...
            style={{ width: 48, height: 48, borderRadius: 10, display: "grid", placeItems: "center", backgroundColor: "#f1f5f9" }}
          >
      ...
      <View style={{ padding: 16 }}>
        ...
        >
          ...
          {job.remote && <Text>• Télétravail</Text>}

          <Text>• {contractLabels[job.contractType] ?? job.contractType}</Text>
        ...
        {job.category && (
          <View
            style={{ display: "inline-block", marginBottom: 12, paddingVertical: 5, paddingHorizontal: 9, borderRadius: 999, backgroundColor: "#f1f5f9" }}
          >
            {job.category}
          </View>
        )}
        ...
        {job.skills.length > 0 && (
          ...
          >
            {job.skills.map((skill) => (
              <Text
                key={skill}
                style={{ paddingVertical: 4, paddingHorizontal: 8, borderRadius: 999, backgroundColor: "#f8fafc", borderWidth: 1, borderColor: "#e2e8f0", borderStyle: "solid", fontSize: 12 }}
              >
                {skill}
              </Text>
            ))}
        ...
        >
          {onOpen && (
            ...
            >
              <Text>Voir l'offre</Text></Pressable>
          )}

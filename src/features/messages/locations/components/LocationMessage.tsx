...
export function LocationMessage({
  ...
  if (!location) {
    return (
      ...
      >
        <Text>Emplacement indisponible</Text></View>
    );
  }
  ...
  return (
    <View
      style={{ width: "100%", maxWidth: 380, overflow: "hidden", borderRadius: 16, borderColor: "#93c5fd", borderStyle: "solid", backgroundColor: "#fff" }}
    >
      {/* MAP */}
      <View
        style={{ position: "relative", height: 190, overflow: "hidden", backgroundColor: "#e2e8f0" }}
      >
        <View
          title={live ? "Position en direct" : "Emplacement partagé"}
        ...
        <View
          style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)", width: 22, height: 22, borderRadius: "50%", backgroundColor: live ? "#2563eb" : "#ef4444", borderWidth: 3, borderColor: "#fff", borderStyle: "solid" }}
        />

        {live && (
          <View
            style={{ position: "absolute", top: 10, left: 10, paddingVertical: 6, paddingHorizontal: 9, borderRadius: 999, backgroundColor: active ? "#2563eb" : "#64748b" }}
          >
      ...
      >
        ...
        >
          ...
          >
            <Text>🗺️ Ouvrir la carte</Text></Pressable>

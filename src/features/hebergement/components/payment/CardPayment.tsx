        ...
        <View className="relative">
          <TextInput
           ...
           maxLength={19}
            ...
            className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-xs text-white placeholder:text-white/20 disabled:opacity-50"
           editable={!(loading)}/>
          <CreditCard
            size={14}
            className="text-white/30 absolute left-3 top-3"
          />
        </View>
      </View>
        ...
        <View className="flex flex-col gap-1">
          ...
          <TextInput
           ...
           maxLength={5}
            ...
            className="w-full px-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-xs text-white placeholder:text-white/20 disabled:opacity-50 text-center"
           editable={!(loading)}/>
        </View>
      ...
      >
        {loading ? (
          <>
            ...
            <Text><Text>Traitement sécurisé...</Text></Text>
          </>
        ) : (
          <>
            <Text>
              <Text>Débiter</Text>{new Intl.NumberFormat("fr-FR").format(amount)} {currency}
            </Text>
            <ArrowRight size={14} />
          </>
        )}

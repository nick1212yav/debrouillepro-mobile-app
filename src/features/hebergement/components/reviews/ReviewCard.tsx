      ...
      <View className="flex items-center justify-between gap-2">
        <View className="flex items-center gap-2.5">
          {authorAvatar ? (
            ...
            <View className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs text-indigo-400 bg-indigo-500/10 border border-indigo-500/15 uppercase">
              {initials}
            </View>
          )}
          <View className="flex flex-col min-w-0">
            ...
            <Text className="text-[10px] text-white/40">{date}</Text>
          </View>
        </View>

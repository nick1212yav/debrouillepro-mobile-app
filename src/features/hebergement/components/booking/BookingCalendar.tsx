    ...
    >
      <View className="flex items-center justify-between mb-4">
        <Text className="text-sm font-semibold text-white flex items-center gap-2">
          ...
          <Text className="capitalize">{monthYearString}</Text>
        </Text>
        <View className="flex gap-1">
          <Pressable
           
            onPress={() => handleMonthChange("prev")}
            className="w-7 h-7 rounded-lg flex items-center justify-center bg-white/5 text-white"
          >
            <ChevronLeft size={16} />
          </Pressable>
          <Pressable
      ...
      <View className="gap-3">
        <View>
          ...
          <TextInput
            ...
            value={checkIn}
            onChangeText={(text) => onChange({ checkIn: text, checkOut })}
        ...
        <View>
          ...
          <TextInput
            ...
            value={checkOut}
            onChangeText={(text) => onChange({ checkIn, checkOut: text })}

        ...
        {safeties.map((s, i) => {
          ...
          return (
            <View key={i} className="flex items-center gap-2">
              <View className="w-7 h-7 rounded-lg bg-indigo-500/10 flex items-center justify-center text-indigo-400 shrink-0">
                <Icon size={14} />
              </View>
              <Text className="text-xs text-white/70">{s.label}</Text>
            </View>
          );
        })}
      </View>

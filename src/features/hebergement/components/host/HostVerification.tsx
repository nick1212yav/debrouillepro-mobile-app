  ...
  return (
    ...
    >
      <Text className="text-xs font-bold text-white/40 uppercase tracking-wider flex items-center gap-1.5">
        ...
        <Text>Sécurité & Vérifications</Text>
      </Text>
      ...
      <View className="flex flex-col gap-2">
        {verifs.map((v, i) => {
          ...
          return (
            <View
              key={i}
              className="flex items-center justify-between p-2 rounded-xl bg-black/20 border border-white/5 text-xs"
            >

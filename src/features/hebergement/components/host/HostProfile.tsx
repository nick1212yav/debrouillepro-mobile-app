    ...
    >
      <View className="flex items-start gap-4">
        {avatar ? (
          ...
          <View className="w-14 h-14 rounded-full flex items-center justify-center font-bold text-base text-white bg-gradient-to-br from-indigo-500 to-purple-500 border border-white/10 shrink-0">
            {initials}
          </View>
        )}
        <View className="flex-1 flex flex-col gap-1">
          ...
          <View className="flex items-center gap-1 text-[10px] text-white/40 font-semibold">
            <Calendar size={12} className="text-indigo-400" />
            <Text>Membre depuis {joinedDate}</Text>
          </View>
        </View>
      </View>
      ...
      <View className="gap-3.5 pt-3.5 border-t border-white/5 text-xs text-white/60">
        ...
        <View className="flex items-center gap-1.5">
          ...
          <Text>
            <Text>Parle :</Text>{" "}
            <strong className="text-white">{languages.join(", ")}</strong>
          </Text>
        </View>
      </View>
    </View>

      ...
      <View className="gap-3 text-xs">
        ...
        {trip.durationMinutes > 0 && (
          <View className="flex items-center gap-3">
            ...
            <View>
              <Text className="text-white/40 text-[10px]">Durée estimée</Text>
        ...
        <View className="flex items-center gap-3">
          ...
          <View>
            <Text className="text-white/40 text-[10px]"><Text>Capacité totale</Text></Text>
            <Text className="text-white font-medium">{trip.totalSeats} <Text>places</Text></Text>
          </View>
        </View>
      </View>
    </View>

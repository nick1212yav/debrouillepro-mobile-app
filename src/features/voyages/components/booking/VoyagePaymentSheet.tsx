  ...
  return (
    <View className="flex flex-col h-full">
      <View className="flex items-center justify-between mb-6">
        ...
        <Pressable onPress={onCancel} className="text-white/40">
          <X size={20} />
        </Pressable>
      </View>
        ...
        <>
          ...
          <View className="mt-4 p-4 rounded-2xl bg-white/5 border border-white/10">
            <View className="flex items-center justify-between text-sm">
              <Text className="text-white/60">Montant</Text>
          ...
          <Pressable
            ...
            className="mt-6 w-full py-3 rounded-2xl text-sm font-bold text-white bg-gradient-to-r from-indigo-500 to-purple-500"
          >
            <Text>Confirmer le paiement</Text></Pressable>
        </>
      )}
        ...
        <View className="space-y-4">
          <View className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
            ...
            <Text className="text-white font-semibold">
              Paiement par {selectedMethod.label}
            </Text>
          ...
          <View className="flex gap-3">
            ...
            <Pressable
              onPress={handlePay}
              disabled={loading}
              className="flex-1 py-3 rounded-2xl text-sm font-bold text-white bg-gradient-to-r from-emerald-500 to-teal-500 disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? (
      ...
      {step === "processing" && (
        <View className="flex flex-col items-center justify-center py-12">
          ...
          <Text className="text-white font-medium"><Text>Traitement du paiement...</Text></Text>
          <Text className="text-white/40 text-sm mt-1"><Text>Veuillez patienter</Text></Text>
        </View>
      )}
    </View>
  );

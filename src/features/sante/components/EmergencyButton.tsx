...
export function EmergencyButton({
  ...
  return (
    <Pressable onPress={onPress} className={`relative flex items-center justify-center gap-3 px-6 py-4 rounded-2xl font-bold text-white bg-gradient-to-r from-red-500 to-red-700 shadow-lg shadow-red-500/30 hover:shadow-red-500/50 transition-all hover:scale-[1.02] active:scale-95 ${className}`}>

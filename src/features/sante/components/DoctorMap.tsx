  ...
  return (
    <View className="p-4 rounded-2xl bg-white/5 border border-white/10">
      ...
      <Pressable
        ...
        className="relative aspect-[16/9] rounded-xl overflow-hidden bg-black/30 border border-white/10"
      >
        {hasCoordinates ? (
          <View
          ...
          <View className="w-full h-full flex flex-col items-center justify-center text-white/30">
            ...
            <Text className="text-xs mt-2"><Text>Cliquez pour ouvrir dans Google Maps</Text></Text>
          </View>
        )}
      </Pressable>
    </View>

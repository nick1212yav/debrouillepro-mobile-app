  ...
  return (
    <Form {...form}>
      <View className="space-y-4 text-left"><FormField control={form.control} name="name" render={({ field }) => (
            ...
            <FormItem>
              <FormLabel>Type d'hôpital *</FormLabel>
          ...
          )} /><View className="gap-3"><FormField control={form.control} name="beds" render={({ field }) => (
              <FormItem>
            ...
            )} /><FormField control={form.control} name="doctors" render={({ field }) => (
              <FormItem>
            ...
            )} /></View><FormField control={form.control} name="services" render={({ field }) => (
            <FormItem>
            ...
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
              <View className="space-y-0.5">
                <FormLabel>Service d'urgence 24h/24</FormLabel>
              </View>
              <FormControl>
                <Switch
          ...
          )} /><FormField control={form.control} name="pharmacy" render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
              <View className="space-y-0.5">
                <FormLabel>Pharmacie intégrée</FormLabel>
              </View>
              <FormControl>
                <Switch

    ...
    >
      ...
      >
        <View
          ...
          style={{ backgroundColor: open ? `${accent}20` : "rgba(255,255,255,0.045)", borderColor: "rgba(255,255,255,0.06)", borderStyle: "solid" }}
        >
          <Icon
            size={17}
        ...
        <View className="flex-1 min-w-0">
          <Text
            ...
            style={{ color: open ? "#fff" : "rgba(255,255,255,0.82)" }}
          >
            {section.title}
          </Text>
          <Text className="text-[10px] text-white/30 mt-0.5 truncate">
            {section.summary}
          </Text>
        </View>
      ...
      <>
        {open && (
          ...
          >
            <View className="px-4 pb-5 pl-[68px]">
              <View
                className="rounded-2xl p-4"
                style={{ backgroundColor: `${accent}08`, borderStyle: "solid" }}
              >
                <Text className="text-sm text-white/55 leading-7">
                  {section.content}
                </Text>
              </View>
            </View>
  ...
  return (
    ...
    >
      ...
      <View
        ...
        style={{ borderColor: "rgba(255,255,255,0.065)", backgroundColor: "rgba(2,6,23,0.72)" }}
      >
        <Pressable
        ...
        <View className="flex-1 min-w-0">
          ...
          <Text className="text-xs text-white/35 mt-0.5">
            Utilisation de Débrouille Pro · Mise à jour : 1er juin 2025
          </Text>
        </View>
        ...
        >
          <ShieldCheck size={12} style={{ color: hex }} />
          <Text className="text-[10px] font-bold" style={{ color: hex }}>
            Document officiel
          </Text>
        </View>
      </View>
      ...
      >
        {/* Hero */}
        <View
          className="relative overflow-hidden rounded-[28px] p-6 mb-5"
          style={{ borderStyle: "solid" }}
        >
          <View
            className="absolute -top-20 -right-12 w-56 h-56 rounded-full"
            style={{  }}
          />
          ...
          <View className="relative z-10">
            ...
            <Text className="text-2xl sm:text-3xl font-black text-white leading-tight">
              Des règles claires pour une
              <Text style={{ color: hex }}> expérience de confiance.</Text>
            </Text>
            ...
            <View className="flex flex-wrap gap-2 mt-5">
              <View
              ...
              >
                <ShieldCheck size={13} style={{ color: hex }} />
                <Text className="text-[10px] text-white/55">10 sections</Text>
              </View>
        ...
        >
          {[
            ...
            <View
              ...
              style={{ backgroundColor: "rgba(255,255,255,0.035)", borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", borderStyle: "solid" }}
            >
        ...
        <View className="flex gap-2 mb-3">
          <View
            className="flex items-center gap-2 flex-1 min-w-0 rounded-2xl px-3.5"
            style={{ backgroundColor: "rgba(255,255,255,0.045)", borderWidth: 1, borderColor: "rgba(255,255,255,0.07)", borderStyle: "solid" }}
          >
            ...
            <TextInput
              ...
              className="w-full bg-transparent py-3 text-xs text-white outline-none placeholder:text-white/20"
            />
          </View>
          ...
          <Pressable
            ...
            onPress={expandAll}
            className="px-3.5 rounded-2xl text-[10px] font-bold text-white/55"
            style={{ backgroundColor: `${hex}12`, borderStyle: "solid" }}
          >
          ...
          {filteredSections.length > 0 ? (
            ...
            <View className="px-6 py-12 text-center">
              <View
                ...
                style={{ backgroundColor: `${hex}12`, borderStyle: "solid" }}
              >
                <Search size={18} style={{ color: hex }} />
              </View>
              <Text className="text-sm font-bold text-white/65">
        ...
        >
          <View className="relative z-10">
            <View className="flex items-start gap-3">
              <View
                className="w-10 h-10 rounded-2xl flex items-center justify-center shrink-0"
                style={{ backgroundColor: `${hex}18`, borderStyle: "solid" }}
              >
                <Mail size={17} style={{ color: hex }} />
              </View>
              ...
              <View className="min-w-0">
                ...
                <Text className="text-xs text-white/35 mt-1 leading-relaxed">
                  Notre équipe juridique peut répondre à tes questions.
                </Text>
                <Pressable
                 
                  className="inline-flex items-center gap-2 mt-3 text-xs font-bold"
                  style={{  }}
                 data-href="mailto:legal@debrouille.pro">
                  <Text>legal@debrouille.pro</Text><Mail size={12} />
                </Pressable>
              </View>
            </View>
          </View>
        ...
        {/* Footer */}
        <View className="text-center pb-5">
          <View className="flex items-center justify-center gap-2 mb-2">
            ...
            <Text className="text-xs font-black text-white/50">
              <Text>Débrouille Pro</Text></Text>
          </View>

          <Text className="text-[10px] text-white/20">
            <Text>© 2025 Débrouille Pro SAS · Kolwezi, RDC · legal@debrouille.pro</Text></Text>
        </View>
      </View>
    </View>
  );

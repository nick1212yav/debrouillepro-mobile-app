...
import HomeWidget from "@/pages/home/_components/HomeWidget.tsx";
import StreakWidget from "@/pages/home/_components/StreakWidget.tsx";
...
type TabId = "apercu" | "activite" | "modules" | "badges" | "analytics";
  ...
  return (
    <View style={styles.root}>
        ...
        >
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                <Icon size={14} color={active ? T.primarySoft : T.dim} />
      ...
      >
        ...
        >
          {/* HomeWidget exige un onNavigate obligatoire.
              DashboardPage le rend donc uniquement lorsque le callback
              de navigation est effectivement disponible. */}
          {activeTab === "apercu" && onNavigate && (
            <HomeWidget onNavigate={onNavigate} />
          )}

  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <View className="text-center border-b border-white/10 pb-4 mb-4">
            <Text className="text-white font-bold text-lg">DÉBROUILLE PRO</Text>
            <Text className="text-white/40 text-xs">Ordonnance médicale</Text>
          </View>
          ...
          <View className="space-y-3 text-sm">
            <View className="flex items-center gap-3">
              ...
              <View>
                <Text className="text-white/40 text-xs">Patient</Text>
            ...
            <View className="flex items-center gap-3">
              <Stethoscope size={16} className="text-white/40" />
              <View>
                <Text className="text-white/40 text-xs">Médecin</Text>
                <Text className="text-white font-medium">
          ...
          <View className="mt-4 pt-4 border-t border-white/10">
            ...
            {prescription.medications?.map((med: any, idx: number) => (
              ...
              >
                <Pill size={16} className="text-orange-400 mt-0.5" />
                <View>
                  <Text className="text-white font-medium">{med.name}</Text>
          ...
          {prescription.notes && (
            <View className="mt-4 pt-4 border-t border-white/10">
              ...
              <Text className="text-white/60 text-sm">{prescription.notes}</Text>
            </View>
          )}

          <View className="mt-4 pt-4 border-t border-white/10 text-center">
            <CheckCircle size={20} className="mx-auto text-green-400 mb-1" />
            <Text className="text-white/30 text-xs">
              <Text>Ordonnance valide jusqu'au</Text>{" "}

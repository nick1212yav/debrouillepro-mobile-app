        ...
        <View className="relative">
          {item.image ? (
            <Image
              ...
              loading="lazy" source={{ uri: item.image }} accessibilityLabel=""
            />
          ) : (
          ...
          {distance && (
            <Text className="absolute bottom-3 left-3 rounded-full border border-white/10 bg-black/60 px-2.5 py-1 text-[11px] font-semibold text-white">
              {distance}
            </Text>
          )}
        </View>
